...
$GLOBALS['data'] = array(
    "brainston" => new Product("BRAINSTON",
        ...
        array(
            ...
            new ProductImage("img/brainston/Brainston-11.jpg",
                ProductImageLayout::FULLSCREEN),
            new ProductImage("img/brainston/Brainston-12.jpg",
                ProductImageLayout::FULLSCREEN),
        )
    ),
    ...
    "various" => new Product("VARIOUS",
        ...
        array(
            new ProductImage("img/various-social.jpg",
                ProductImageLayout::FULLSCREEN),
            new ProductImage("img/various-social-02.jpg",
                ProductImageLayout::FULLSCREEN),
            new ProductImage("img/various-social-03.jpg",
                ProductImageLayout::FULLSCREEN),
            new ProductImage("img/various-social-04.jpg",
                ProductImageLayout::FULLSCREEN),
            new ProductImage("img/various-social-05.jpg",
                ProductImageLayout::FULLSCREEN),
            new ProductImage("img/various-social-06.jpg",
                ProductImageLayout::FULLSCREEN),
        )
    ),
